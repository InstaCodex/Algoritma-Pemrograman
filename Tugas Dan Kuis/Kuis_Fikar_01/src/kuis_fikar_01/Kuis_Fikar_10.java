...
public class Kuis_Fikar_10 {
    ...
    //WAKTU
    public static String tanggal ="", bulan ="", lokasi ="";
    public static int n_tanggal =0;
    ...
    public static void main (String [] args)
    {
        ...
        lokasi = JOptionPane.showInputDialog("LOKASI SURVEY");
        do {
            try {
                tanggal = JOptionPane.showInputDialog("TANGGAL");
                n_tanggal = Integer.parseInt(tanggal);
                putar = false;
            }
            catch(Exception e) {
        ...
        do
        {
          ...
          info +="          LAPORAN BENCANA DAERAH             \n";
          info +=" ------------------------------------------- \n";
          info +=" NO TAHUN SELAMA TEMPAT KEJADIAN SK REKTER RK \n";
          info +=" ------------------------------------------- \n";
          no=0;
          g=0;
          s=0;
          ...
          info="";
                ...
                case "3" : {
                            ...
                            {   
                                ...
                                while(!(n_id>=1 & n_id<=(x+1)));  
                                 d=n_id-1; // d adalah nilai array / n_id nilai user
                                info = ""; 
                                info += "Data ke = "+n_id+"\n";
                                info += " TAHUN KEJADIAN  = "+th_kejadian[d]+"\n";
                                info += " TEMPAT          = "+tempat[d]+"\n";
                                ...
                                {
                                    //  hapus data
                                    if(n_id>=1 & n_id<(x+1)) // bertemu di antara 0 - di depan nilai x
                                    {
                                    ...
                                    else if(n_id == (x+1)) // bertemu pada ruang akhir
                                    {
                                        x = x -1;
                                    }
                                     info = "";
        ...
        else // 2 - tak terhingga
            {
               ...
               for (int ut =1; ut<=h;ut = ut+1)
               {
                ...
                info+="HAL  ="+ut+"\n";
                        info += "                       LAPORAN BENCANA DAERAH                  \n";
                        info += "Tanggal"+" "+tanggal+" "+bulan+" "+n_st+" "+"Lokasi survey di "+lokasi+"\n";
                        info += "---------------------------------------------------------------\n";
                        info += " No    Tahun  Selama   Tempat  Kejadian    SKrekter    Rk      \n";
                        info += "---------------------------------------------------------------\n";
                        no = 0;
                        g=0; s=0; b=0;
                if (ut==h)// halaman terakhir
                {
                    x2=(x+1);
                }
                 for (int z =x1; z<=x2;z = z+1)
                  {
                   ...
                   info += "---------------------------------------------------------------\n";
                        ...
                        info += "       BANJIR   = "+b+"\n";
                   x1=x1+3;
                   x2=x2+3; // bukan halaman terakhir
