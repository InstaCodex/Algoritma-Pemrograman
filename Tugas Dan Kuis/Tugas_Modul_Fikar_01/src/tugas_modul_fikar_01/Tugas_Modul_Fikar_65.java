...
public class Tugas_Modul_Fikar_65 {
//CONTOH VARIABEL GLOBAL
    public static String jk = "", lagi = "y", info = "", po = "", je = "", pil = "";
    public static int n_jk = 0, gt = 0, totp = 0, totl = 0, tl = 0, tp = 0, 
                      no = 0, x = 0, z = -1, y = 0, l = 0, p = 0, n_dp = 0;
    ...
    public static void main(String[] args) {
        ...
        String u1 = "";
        String u2 = "";
        float nilaiKehadiran=0f;
        float nilaiKinerja=0f;
        String jk = "";
        //ARRAY
